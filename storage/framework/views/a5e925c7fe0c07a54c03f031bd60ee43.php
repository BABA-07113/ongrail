...
<?php $__env->startSection('title', "RAIL Bénin | Réseau d'Appui aux Initiatives Locales"); ?>
...
<section id="hero" class="relative min-h-screen flex items-center overflow-hidden pt-20">
    ...
    <div class="absolute inset-0 z-0">
        <img src="<?php echo e(asset('images/Distribution_des_fonds.jpg')); ?>" alt="" class="w-full h-full object-cover">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 min-h-[75vh] items-center">
                ...
                <div class="lg:col-span-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center gap-2.5 px-8 py-4 text-sm font-bold tracking-wider text-[#021E12] bg-[#FBB507] hover:bg-[#E5A406] hover:-translate-y-0.5 transition-all duration-300 shadow-lg">
                            Découvrir notre mission
                            <i class="fas fa-arrow-right text-xs"></i>
                        </a>
                        <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2.5 px-8 py-4 text-sm font-bold tracking-wider text-white/60 border border-white/20 hover:bg-white/5 hover:text-white hover:border-white/30 transition-all duration-300">
                            Nous contacter
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-6 flex justify-center lg:justify-start">
                    <div class="w-full max-w-[36rem] lg:max-w-[42rem] drop-shadow-2xl">
                        <img src="<?php echo e(asset('images/logo2-transparent.png')); ?>" alt="RAIL Bénin" class="w-full h-auto object-contain">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
            <div class="relative group">
                ...
                <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src="<?php echo e(asset('images/galleries/Photo_banniere_ecole.jpg')); ?>" alt="Mission RAIL Bénin" class="w-full h-[440px] lg:h-[520px] object-cover" loading="lazy">
            ...
            <div>
                ...
                <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center gap-2.5 text-sm font-bold tracking-wider text-primary-600 hover:text-primary-700 transition-all duration-300 group">
                    <span class="relative">
                        En savoir plus
...
<section class="relative overflow-hidden py-20 lg:py-28 bg-gradient-to-b from-white to-primary-50/20">
    ...
    <div class="container relative z-10">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $articles->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="group mb-8 lg:mb-10 last:mb-0">
            <article class="relative rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 bg-white border border-ink-100/50">
                <div class="grid grid-cols-1 lg:grid-cols-12 items-center">
                    <div class="lg:col-span-7 relative overflow-hidden min-h-[280px] lg:min-h-[380px] <?php echo e($index % 2 === 1 ? 'lg:order-2' : ''); ?>">
                        <img src="<?php echo e($article->featured_image ? asset($article->featured_image) : asset('images/galleries/img-1465_orig.jpg')); ?>" alt="<?php echo e($article->title); ?>" class="absolute inset-0 w-full h-full object-cover" loading="lazy">
                        <div class="absolute inset-0 bg-gradient-to-r from-black/20 to-transparent <?php echo e($index % 2 === 1 ? 'lg:bg-gradient-to-l' : ''); ?>"></div>
                    </div>
                    <div class="lg:col-span-5 p-8 lg:p-10 lg:px-12 premium-border-l">
                        <?php if($article->category): ?>
                        <span class="inline-block px-3 py-1.5 text-[0.625rem] font-bold tracking-wider uppercase bg-primary-50 text-primary-600 rounded-lg w-fit mb-4"><?php echo e($article->category->name); ?></span>
                        <?php endif; ?>
                        ...
                        <a href="<?php echo e(route('articles.show', $article->slug)); ?>" class="inline-flex items-center gap-2.5 text-sm font-bold tracking-wider text-primary-600 bg-primary-50 rounded-xl px-5 py-3 hover:bg-primary-100 transition-all duration-300 group/link">
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('articles.index')); ?>" class="inline-flex items-center gap-2.5 px-8 py-4 text-sm font-bold tracking-wider rounded-xl text-white bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 hover:-translate-y-0.5 transition-all duration-300 shadow-lg shadow-primary-600/20">
...
<section class="relative overflow-hidden py-20 lg:py-28 bg-gradient-to-br from-[#F8F7F6] via-white to-primary-50/30">
    ...
    <div class="container relative z-10">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $projects->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php if($index === 0): ?>
        <div class="mb-8 lg:mb-10 group">
            <article class="relative rounded-2xl overflow-hidden shadow-lg premium-border-hero">
                <div class="relative min-h-[420px] lg:min-h-[520px] flex items-end">
                    <img src="<?php echo e($project->featured_image ? asset($project->featured_image) : asset('images/galleries/image1.jpg')); ?>" alt="<?php echo e($project->title); ?>" class="absolute inset-0 w-full h-full object-cover" loading="lazy">
                    ...
                    <div class="relative z-10 p-8 lg:p-12 w-full max-w-3xl">
                        ...
                        <?php elseif($project->status === 'termine'): ?>
                        ...
                        <span class="text-white/50 text-xs mb-2 block"><?php echo e($project->category->name); ?></span>
                        <?php endif; ?>
                        <h3 class="text-3xl lg:text-4xl font-display font-bold text-white leading-tight mb-4 group-hover:text-accent-300 transition-colors duration-300">
                            <a href="<?php echo e(route('projects.index')); ?>"><?php echo e($project->title); ?></a>
                        </h3>
                        <p class="text-white/70 leading-relaxed mb-6 line-clamp-2 max-w-xl">
                            <?php echo e(Str::limit(strip_tags($project->content), 150)); ?>

                        </p>
                        <a href="<?php echo e(route('projects.index')); ?>" class="inline-flex items-center gap-2.5 text-sm font-bold tracking-wider text-white bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl px-6 py-3 hover:bg-white/20 hover:border-white/30 transition-all duration-300 group/link">
            ...
            <article class="group relative bg-white rounded-2xl overflow-hidden shadow-sm transition-all duration-500 premium-border-card">
                <div class="flex flex-col sm:flex-row items-stretch">
                    ...
                    <div class="flex-1 p-5 lg:p-6 flex flex-col justify-center">
                        <?php if($project->category): ?>
                        <span class="text-xs text-ink-400 mb-1"><?php echo e($project->category->name); ?></span>
                        <?php endif; ?>
                        ...
                        <p class="text-xs text-ink-400 leading-relaxed line-clamp-2 mb-3">
                            <?php echo e(Str::limit(strip_tags($project->content), 100)); ?>

                        </p>
                        <a href="<?php echo e(route('projects.index')); ?>" class="inline-flex items-center gap-1.5 text-[0.6rem] font-bold tracking-wider uppercase text-accent-400 group/link">
        ...
        <?php endif; ?>
        <?php if($projects->count() > 0 && $projects->count() > 1): ?>
        </div>
        <?php endif; ?>

        <?php if($projects->count() > 0): ?>
        <div class="text-center mt-12">
            <a href="<?php echo e(route('projects.index')); ?>" class="inline-flex items-center gap-2.5 px-8 py-4 text-sm font-bold tracking-wider rounded-xl text-primary-900 bg-gradient-to-r from-accent-400 to-accent-500 hover:from-accent-500 hover:to-accent-600 hover:-translate-y-0.5 transition-all duration-300 shadow-lg shadow-accent-500/20">
    ...
    <div class="container text-center relative z-10">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2.5 px-8 py-4 text-sm font-bold tracking-wider text-accent-600 bg-white hover:bg-white/90 hover:-translate-y-0.5 transition-all duration-300 rounded-xl shadow-2xl shadow-black/20">
                    <i class="fas fa-handshake"></i>
                    Devenir partenaires
                </a>
                <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center gap-2.5 px-8 py-4 text-sm font-bold tracking-wider text-white/80 border-2 border-white/20 hover:bg-white/10 hover:text-white hover:border-white/30 transition-all duration-300 rounded-xl">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ongRail\resources\views/pages/home.blade.php ENDPATH**/ ?>