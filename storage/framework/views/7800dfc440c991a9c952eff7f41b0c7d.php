...
<?php $__env->startSection('title', 'Galeries - RAIL Bénin'); ?>
...
<section class="section">
    <div class="container">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 stagger">
            ...
            <a href="<?php echo e(route('galleries.show', $gallery->slug)); ?>" class="article-card group animate-fade-up" style="animation-delay:<?php echo e($loop->index * 60); ?>ms">
                <div class="relative overflow-hidden !aspect-[4/3]">
                    <img src="<?php echo e($gallery->cover_image ? asset($gallery->cover_image) : ($gallery->images->first()?->image ? asset($gallery->images->first()->image) : asset('images/galleries/img-4260_orig.jpg'))); ?>" alt="<?php echo e($gallery->title); ?>" loading="lazy">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center z-10">
                        <span class="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-black/50 backdrop-blur-sm border border-white/20 text-white text-xs font-bold shadow-lg transition-all duration-300 group-hover:bg-accent-400 group-hover:text-primary-900 group-hover:border-accent-400">
                            <i class="fas fa-images"></i>
                            Voir les photos
                            <span class="inline-flex items-center justify-center min-w-[1.5rem] h-5 px-1 rounded-full bg-white/20 text-[0.6rem] font-bold group-hover:bg-primary-900 group-hover:text-accent-400"><?php echo e($gallery->images->count()); ?></span>
                        </span>
                    </div>
                </div>
                <div class="article-card-body">
                    ...
                    <div class="text-xs text-surface-400 flex items-center gap-1.5">
                        <i class="far fa-images"></i> <?php echo e($gallery->images->count()); ?> photos
                    </div>
                </div>
            </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ongRail\resources\views/pages/galleries/index.blade.php ENDPATH**/ ?>